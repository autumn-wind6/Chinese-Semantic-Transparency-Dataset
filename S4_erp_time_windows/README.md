...
1. `data/input/erp_data_analysis.csv`
...
- `results/erp_time_window_results.csv`: coefficients, standard errors, unadjusted p-values, and FDR results for the machine-generated scores in TW1-TW10.
- `results/erp_window_overlap.csv`: overlap between time windows significant for the machine-generated scores and those significant for human ratings in the original article.
